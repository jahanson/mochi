  ...
  config = lib.mkIf osConfig.mySystem.de.gnome.enable {
    ...
    dconf.settings = {
      ...
      "org/gnome/shell" = {
        ...
        favorite-apps = [ "org.gnome.Nautilus.desktop" "com.mitchellh.ghostty.desktop" "org.wezfurlong.wezterm.desktop" "vivaldi-stable.desktop" "obsidian.desktop" "code.desktop" "discord.desktop" ];
      };
