  ...
  config = lib.mkIf osConfig.mySystem.de.gnome.enable {
    ...
    dconf.settings = {
      ...
      "org/gnome/shell" = {
        ...
        favorite-apps = [ "org.gnome.Nautilus.desktop" "vivaldi-stable.desktop" "termius-app.desktop" "com.mitchellh.ghostty.desktop" "org.wezfurlong.wezterm.desktop" "obsidian.desktop" "code.desktop" "discord.desktop" ];
      };
